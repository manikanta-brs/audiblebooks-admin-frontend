...
const StatisticsPage = () => {
  const [chartType, setChartType] = useState("pie"); // Starting with pie chart
  const chartRef = useRef(null);
  const {
    data: usersCount,
    isLoading: usersLoading,
  ...
  const handleUsersClick = () => {
    navigate("/users"); // Directs to users page
  };

  const handleAuthorsClick = () => {
    navigate("/authors"); // Directs to authors page
  };

  const handleAudiobooksClick = () => {
    navigate("/audiobooks"); // Directs to audiobooks page
  };
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        {/* Number blocks with navigation */}
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div
            className="bg-blue-50 p-4 rounded-lg shadow-sm cursor-pointer hover:bg-blue-100"
          ...
          <div
            className="bg-green-50 p-4 rounded-lg shadow-sm cursor-pointer hover:bg-green-100"
          ...
          <div
            className="bg-yellow-50 p-4 rounded-lg shadow-sm cursor-pointer hover:bg-yellow-100"
