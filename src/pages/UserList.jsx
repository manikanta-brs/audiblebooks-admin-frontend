...
const UserList = () => {
  ...
  const handleDelete = async (user) => {
    Swal.fire({
      title: "Are you sure?",
      text: `You are about to delete user: ${user.first_name} ${user.last_name} (Email: ${user.email}). You won't be able to revert this!`,
      icon: "warning",
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead className="text-xs text-gray-700 uppercase bg-gray-800 dark:bg-gray-900 dark:text-gray-400">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-center w-48 text-white">
                {" "}
                {/* Adjust width here */}
                Actions
              </th>
                  ...
                  <>
                    <td className="px-6 py-4">
                      <input
                        ...
                        className="shadow-sm bg-gray-800 border border-gray-700 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      />
                    </td>
                    <td className="px-6 py-4">
                      <input
